...
class Map(object):
	def __init__(self, e=None, corners = None ):
		self.invalids = variable
		self.xdimen = 
		self.ydimen = []
		self.segments = 
		...
		while(True):
			...
			if leg[1].corners[leg[1].corners.length() - 1].connection_slopes[leg[1].corners[leg[1].corners.length() - 1].connection_slopes.length() - 1] > 1:
				if (leg[2].corners[leg[2].corners.length() - 1].connection_slope[0] > 1):
					pass
			elif (leg[1].corners[leg[1].corners[-1]] == leg[2].corners[leg[2].corners.length() - 1:
				points = draw(leg[1].corners[leg[1].corners[-1]].point, leg[2].corners[leg[2].corners[-1]].point[0], slope_find(leg[1].corners[leg[1].corners[-1]].point), leg[2].corners[leg[2].corners[-1]].point))
				break
				
			else:
				break
			leg[1].corners.append(leg[1].corners[leg[1].corners[-1]].connection_slopes[leg[1].corners[leg[1].corners[-1]].connection_slopes[-1]])
			leg[2].corners.append(leg[2].corners[leg[2].corners[-1]].connection_slopes[0])
			leg[1].segments.append(leg[1].corners[leg[1].corners[-1]].segments[leg[1].corners[leg[1].corners[-1]].segments[-1]])
			leg[2].segments.append(leg[2].corners[leg[2].corners[-1]].segments[0])
		segments_list = []
		corners_list = []
